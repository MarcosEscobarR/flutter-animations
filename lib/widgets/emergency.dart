    ...
    return Container(
      ...
      decoration: BoxDecoration(
          ...
          gradient: LinearGradient(
              ...
              colors: <Color>[Color(0xff526bF6), Color(0xff67ACD2)])),
    );
  }
}
...
class FatButton extends StatelessWidget {
  ...
  const FatButton(
      {this.icon, this.text, this.color1, this.color2, this.function});
...
class _FatButtonBackground extends StatelessWidget {
  ...
  const _FatButtonBackground({@required this.icon, this.color1, this.color2});
